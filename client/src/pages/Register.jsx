    ...
    <div className="font-manhope min-h-screen flex items-center justify-center bg-white text-slate-900 antialiased px-4">
      <div className="w-full max-w-sm">
        <div className="mb-10">
          ...
          <h2 className="text-xl font-medium tracking-tight text-slate-800">Create account</h2>
        </div>
        ...
        <p className="text-xs text-slate-400 font-light mt-6 text-center">
          Have an account?{' '}
          <Link to="/login" className="text-slate-600 hover:text-slate-900 font-medium border-b border-dotted border-slate-300">
            Sign in
          </Link>
        </p>
      </div>
